...
export default function Signup() {
  ...
  const handleClick = async (e) => {
    ...
    const response = await fetch(`${process.env.REACT_APP_BACKEND}/auth/getlocation`, {
      method: 'POST',
      headers: {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    const response = await fetch(`${process.env.REACT_APP_BACKEND}/auth/createuser`, {
      // credentials: 'include',
    ...
    <div style={{ backgroundImage: 'url("https://images.pexels.com/photos/1565982/pexels-photo-1565982.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1")', backgroundSize: 'cover',height: '100vh' }}>
      ...
      <Navbar />
        ...
        <div className='container' >
          <form className='w-50 m-auto mt-5 border bg-info border-success rounded' onSubmit={handleSubmit}>
            <div className="m-3">
